...
# Channel Information
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", "-1002153948253"))
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002165306771')).split()]
...
class Var(object):
    ...
    BIN_CHANNEL = int(getenv('BIN_CHANNEL', '-1002153948253'))
